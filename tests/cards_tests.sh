...
function test_generate_cards () {
    ...
    local actual_output=$( generate_cards "$pokemon_data" "$pokemon_type" "$card_template" )
...
function generate_cards_test_cases () {
    ...
    test_generate_cards "$pokemon_data" "grass" "$card_template" "$expected_output" "$test_case"
}
